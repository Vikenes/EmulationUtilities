...
from .moment_loss import moment_loss
from .activations import Speculator
from .scheduler import ReduceStopLROnPlateau
...
class FullyConnected(pl.LightningModule):
    ...
    def custom_step(self, batch, batch_idx):
        ...
        y_hat = self(x,)
        #if is instance :
        #    return self.loss_fct(y_hat, y, sigma_y=sigma_y)
